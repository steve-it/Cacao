...
<head>
    ...
    <link href={{asset("AdminLTE-2.3.9/bootstrap/css/bootstrap.css")}}>
    <!-- Font Awesome
    ...
    <link href={{asset("AdminLTE-2.3.9/plugins/jvectormap/jquery-jvectormap-1.2.2.css")}}>
    <!-- Theme style
    <link rel="stylesheet" href="dist/css/AdminLTE.min.css">-->
    <link href={{asset("AdminLTE-2.3.9/dist/css/AdminLTE.css")}}>
    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load.
    <link rel="stylesheet" href="dist/css/skins/_all-skins.min.css">-->
    <link href={{asset("AdminLTE-2.3.9/dist/css/skins/_all-skins.css")}}>
...
<script src={{asset("AdminLTE-2.3.9/dist/js/app.js")}}></script>
<!-- Sparkline
